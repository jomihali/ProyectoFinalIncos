...
if(isset($_SESSION['S_IDUSUARIO'])){
	...
	// aqui se pone la vista a la que se va a redireccionar
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
		...
		<div class="container-login100" style="background-image: url('images/fondo.jpg');">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="username" placeholder="Ingresa el usuario" id="txt_usu" autocomplete="new-password">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Contrase&ntilde;a</span>
						<input class="input100" type="password" name="pass" placeholder="Ingresa la contrase&ntilde;a" id="txt_con">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
	...
	<!-- modal restablecer contraseña por email -->
	<div class="modal fade" id="modal_restablecer_contra" role="dialog">
			...
			<div class="modal-content">
					...
					<div class="modal-body">
							<div class="col-lg-12">
									<label for=""><b>Ingresa el email registrado en el usuario para enviar la contrase&ntilde;a restablecida</b></label>
