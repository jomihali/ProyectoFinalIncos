...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>PCBOX</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" onclick="AbrilModalEditarContra()" class="btn btn-default btn-flat">Modificar contrase&ntilde;a</a>
                </div>
                <div class="pull-right">
									<!-- para llamar a cerrar sesion desde vista inicio -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img id="img_lateral" class="img-circle" alt="User Image">
				...
				<!-- pondra el nombre de la sesion que es inicio -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <a onclick="cargar_contenido('contenido_principal','cliente/vista_cliente_listar.php')">
        ...
        <a onclick="cargar_contenido('contenido_principal','tecnico/vista_tecnico_listar.php')">
          ...
          <a onclick="cargar_contenido('contenido_principal','servicio/vista_servicio_listar.php')">
           ...
           <a onclick="cargar_contenido('contenido_principal','especialidad/vista_especialidad_listar.php')">
            <i class="fa fa-wrench"></i><span>Especialidad</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
				...
				<div class="modal-body">
						<div class="col-lg-12">
							<input type="text" id="txtcontra_bd" hidden>
								...
								<input type="password" class="form-control" id="txtcontraactual_editar" placeholder="Ingresa la contrase&ntilde;a actual"><br>
						</div>
						<div class="col-lg-12">
								<label for="">Contrase&ntilde;a nueva</label>
								<input type="password" class="form-control" id="txtcontranu_editar" placeholder="Ingresa la contrase&ntilde;a nueva" ><br>
						</div>
						<div class="col-lg-12">
								<label for="">Repetir Contrase&ntilde;a</label>
								<input type="password" class="form-control" id="txtcontrare_editar" placeholder="Repite la contrase&ntilde;a" ><br>
						</div>
				</div>
